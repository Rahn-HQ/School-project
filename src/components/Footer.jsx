         ...
         <div className=' mr-32 max-md:mr-0 text-left max-md:mt-10'>
            ...
            <div className='mt-3'>
              ...
              <Link href="/activates">
                ...
                <p className=' hover:text-[#c3e3eb] transition-colors delay-100 hover:border-[#c3e3eb] text-[#F89C23] border-b border-[#F89C23] mt-5'>ACTIVATES</p>
              
              </Link>
              <Link href="/school-staff">
                
                <p className=' hover:text-[#c3e3eb] transition-colors delay-100 hover:border-[#c3e3eb] text-[#F89C23] border-b border-[#F89C23] mt-5'>SCHOOL-STAFF</p>
