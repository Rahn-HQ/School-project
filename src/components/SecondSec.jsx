      ...
      <div className='flex justify-between  mx-[15%] max-xl:mx-[5%] max-lg:mx-[3%] max-md:mx-[2%]   py-[5%] max-md:block'>
        ...
        <div className=' w-[50%]  max-md:w-[100%]' onClick={() => setSecondSecOP(0)}>
          ...
          <Link href="/school-staff">
            ...
            <button className=' bg-[#F89C23] my-auto mt-7 max-md:text-sm  py-3 px-6 rounded font-bold max-lg:text-base transition ease-in-out delay-100  hover:-translate-y-1 hover:scale-110  duration-200'>LEARN MORE</button>
